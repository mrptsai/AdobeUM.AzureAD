#
# Module manifest for module 'AdobeUM.AzureAD'
#
...
@{
    ...
    GUID = '793bf77a-6f3a-4297-962a-4e6df53fe59b'
    ...
    Copyright = '(c) 2018 Paul Towler and contributors. All rights reserved.'
    
    # Description of the functionality provided by this module
    Description = 'Provides cmdlets to for communicating with the Adobe User Management API. Works with Azure AD or Active Directory'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Adobe', 'API', 'PowerShell', 'AzureAD')
    
            # A URL to the license for this module.
            LicenseUri = 'https://github.com/mrptsai/AdobeUM.AzureAD/blob/master/LICENSE'
    
            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/mrptsai/AdobeUM.AzureAD/tree/master'
    ...
    * Added the cability to create FederationID users
    ...
    HelpInfoURI = 'https://github.com/mrptsai/AdobeUM.AzureAD'
