#
# Module manifest for module 'AdobeUM'
#
...
@{
    ...
    GUID = '55d3fe5d-3ef4-432a-815b-d47934ae2559'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            Tags = @('Adobe', 'API', 'PowerShell')
    
            # A URL to the license for this module.
            LicenseUri = 'https://github.com/mrptsai/AdobeUM/blob/master/LICENSE'
    
            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/mrptsai/AdobeUM/tree/master'
    ...
    * Updated Manifest File
    ...
    HelpInfoURI = 'https://github.com/mrptsai/AdobeUM'
